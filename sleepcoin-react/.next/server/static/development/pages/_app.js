...
/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_3___default()(_redux_store__WEBPACK_IMPORTED_MODULE_6__["initStore"])(class MyApp extends next_app__WEBPACK_IMPORTED_MODULE_2___default.a {
  ...
  componentDidMount() {
    if (localStorage.jwtToken) {
      const decoded = jwt_decode__WEBPACK_IMPORTED_MODULE_5___default()(localStorage.jwtToken);
      this.props.store.dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_4__["setCurrentUser"])(decoded));
      const currentTime = Date.now() / 1000;

      if (decoded.exp < currentTime) {
        this.props.store.dispatch(Object(_redux_actions__WEBPACK_IMPORTED_MODULE_4__["logoutUser"])());
...
/* harmony default export */ __webpack_exports__["default"] = ((state = INITIAL_STATE, action) => {
  switch (action.type) {
    ...
    case _types__WEBPACK_IMPORTED_MODULE_0__["GET_CAMPAIGNS"]:
      {
        return _objectSpread({}, state, {
